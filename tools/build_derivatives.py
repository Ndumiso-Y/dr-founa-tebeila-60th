...
SPEC = {
    ...
    # 02 Young Fona — Pretoria / pre-family years (client-supplied re-photographed prints,
    # 960x1280 sources: cropped to the print, never enlarged; 0470 is a sideways print)
    466: (0, (0.01, 0.045, 0.925, 0.99), 1600), 467: (0, (0.03, 0.055, 0.872, 0.935), 1600),
    468: (0, (0.03, 0.045, 0.90, 0.965), 1600), 469: (0, (0.155, 0.04, 0.95, 0.915), 1600),
    470: (90, (0.165, 0.05, 0.955, 0.965), 1600), 471: (0, (0.06, 0.03, 0.955, 0.97), 1600),
